# Generated by Django 4.1.4 on 2023-01-05 15:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ManyToManyField(blank=True, null=True, to='card.card_main')),
                ('friends', models.ManyToManyField(blank=True, null=True, to='card.card_main')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='car_model', to='card.car')),
            ],
        ),
        migrations.AddField(
            model_name='car',
        ...
        migrations.CreateModel(
            name='Comments',
            fields=[
                ('card_comment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='comments', serialize=False, to='card.card_main')),
